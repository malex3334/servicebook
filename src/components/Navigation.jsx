  ...
  return (
    <div>
      <ul className="nav-list">
        <NavLink className='navlink' to="/start">Start</NavLink>
        ...
        {isLogged ? (
          ...
          <>
            <NavLink className='navlink' to="/cars">My Garage</NavLink>
            {user ? (
              <span className="user_container">
                Hello, {user.displayName != null  ? user.displayName : 'Anonymous'}
                {/*to do: default user photo or icon */}
                <img alt='user avatar' className="user_img" src={user?.photoURL}></img>
              </span>
            ) : null}
